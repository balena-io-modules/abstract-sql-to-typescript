...
test(
	'correct types for a test table with inlineWriteReferences=true',
	testTable,
	source`
		export interface Parent {
			Read: {
...
test(
	'correct types for a test table with inlineWriteReferences=true and convertSerialToInteger=true',
	testTable,
	source`
		export interface Parent {
			Read: {
